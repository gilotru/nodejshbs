...
exports.create = (req, res) => {
  ...
  // User the connection
  connection.query('INSERT INTO user_table SET first_name = ?, last_name = ?, email = ?, phone_number = ?, comment = ?', [first_name, last_name, email, phone, comments], (err, rows) => {
    if (!err) {
...
exports.update = (req, res) => {
  ...
  // User the connection
  connection.query('UPDATE user_table SET first_name = ?, last_name = ?, email = ?, phone_number = ?, comment = ? WHERE id = ?', [first_name, last_name, email, phone_number, comments, req.params.id], (err, rows) => {
...
exports.delete = (req, res) => {
  ...
  // User the connection
  // connection.query('DELETE FROM user_table WHERE id = ?', [req.params.id], (err, rows) => {
